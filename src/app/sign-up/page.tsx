  ...
  const onSignUp = async () => {
    try {
      ...
      if (!username && !email && !password && !confPassword) {
        alert("Mohon isi semua form input");
        return; // agar tidak lanjut ke fungsi berikutnya
      }
      // Tahap pemeriksaan password
      ...
      // Menyimpan data ke backend less menggunakan axios
